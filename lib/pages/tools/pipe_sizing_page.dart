...
class GasPipeSizingPage extends StatefulWidget {
  static const route = '/pipe-sizing';

  const GasPipeSizingPage({Key? key}) : super(key: key);

  @override
  State<GasPipeSizingPage> createState() => _GasPipeSizingPageState();
}

class _GasPipeSizingPageState extends State<GasPipeSizingPage> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            //     ...section.appliances.asMap().entries.map((entry) {
            //       int i = entry.key;
            ...
            //             Expanded(
            //               child: TextFormField(
            //                 initialValue: app.kw.toString(),
            //                 decoration: InputDecoration(labelText: "kW"),
            //                 keyboardType: TextInputType.number,
            //                 onChanged: (val) =>
            //                     app.kw = double.tryParse(val) ?? 0,
            //               ),
            //             ),
            //             IconButton(
            //               icon: Icon(Icons.delete),
            //               onPressed: () {
            //                 setState(() => section.appliances.removeAt(i));
            //               },
            //             )
            //           ],
            //         ),
            ...
            //     //   onPressed: () {
            //     //     setState(() {
            //     //       section.appliances.add(Appliance(name: "", kw: 0));
            //     //     });
            //     //   },
